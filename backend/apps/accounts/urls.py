...
urlpatterns = [
    ...
    path('password-reset/', views.password_reset_request, name='password_reset_request_alt'),
    path('password-reset/confirm/', views.password_reset_confirm, name='password_reset_confirm_alt'),
    ...
    path('technician-documents/', views.technician_documents, name='technician_documents'),
    path('technician-documents/<int:document_id>/', views.technician_document_detail, name='technician_document_detail'),
