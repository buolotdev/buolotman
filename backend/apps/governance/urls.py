...
urlpatterns = [
    ...
    path("platform-settings-list/", views.platform_settings_list, name="platform_settings_list"),
    ...
    path("my-support/", views.user_support_tickets, name="user_support_tickets"),
    path("my-support/<int:ticket_id>/reply/", views.user_support_ticket_reply, name="user_support_ticket_reply"),
