...
# Email Configuration (AWS SES SMTP - Europe Stockholm eu-north-1)
EMAIL_BACKEND = config('EMAIL_BACKEND', default='django.core.mail.backends.smtp.EmailBackend')
EMAIL_HOST = config('EMAIL_HOST', default='email-smtp.eu-north-1.amazonaws.com')
EMAIL_PORT = config('EMAIL_PORT', default=587, cast=int)
EMAIL_USE_TLS = config('EMAIL_USE_TLS', default=True, cast=bool)
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='AKIAYYNAA6DHZP5L7N3M')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='BDu9pgBYN2ORlwtWv04pXL3OJKPLcd6IAksKTLdfOK9w')
