...
MEDIA_URL = '/media/'
import os
MEDIA_ROOT = Path('/var/app/media') if os.path.exists('/var/app') else (BASE_DIR / 'media')
...
# ASGI / Channels Configuration (WebSockets Live Chat)
...
# Email Configuration (cPanel Webmail SMTP / AWS SES SMTP)
EMAIL_BACKEND = config('EMAIL_BACKEND', default='django.core.mail.backends.smtp.EmailBackend')
EMAIL_HOST = config('EMAIL_HOST', default='space.vivawebhost.com')
EMAIL_PORT = config('EMAIL_PORT', default=465, cast=int)
EMAIL_USE_TLS = config('EMAIL_USE_TLS', default=False, cast=bool)
EMAIL_USE_SSL = config('EMAIL_USE_SSL', default=True, cast=bool)
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='no-reply@boulotman.com')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='no-reply@boulotman254')
