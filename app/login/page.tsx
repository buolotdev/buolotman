...
const translations: Record<string, Record<string, any>> = {
  ...
  fr: {
    ...
    phFirstName: "",
    labelMiddleName: "Deuxième prénom (optionnel)",
    phMiddleName: "",
        ...
        <div className={styles.content}>
          ...
          <div className={`${styles.step} ${step === "account" ? styles.active : ""}`}>
            ...
            <button 
              ...
              onClick={() => {
                if (!selectedRole) {
                  setError("Please select an account type above (Client, Company, or Technician) to continue with Google.");
                  return;
                }
                handleGoogleAuth();
              }} 
            ...
            >
              ...
              {selectedRole ? `Continue with Google as ${selectedRole}` : t.continueGoogle}
            </button>
