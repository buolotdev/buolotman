...
import pageStyles from "@/app/dashboard/company/page.module.css";
...
const translations: Record<string, Record<string, string>> = {
  en: {
    myTickets: "Enterprise Support Tickets",
    newTicket: "New",
    noTickets: "No support tickets yet.",
    backToTickets: "Back to Tickets",
    createNewTicket: "Create New Support Ticket",
    subject: "Subject",
    subjectPlaceholder: "E.g. Issue with corporate billing, contracts, or verification",
    describeIssue: "Describe your issue",
    issuePlaceholder: "Please provide details so we can assist your company...",
    cancel: "Cancel",
  ...
  fr: {
    myTickets: "Tickets d'Assistance Entreprise",
    newTicket: "Nouveau",
    ...
    subject: "Objet",
    subjectPlaceholder: "Ex. Facturation entreprise, contrats ou vérification",
  ...
  return (
    <main className={pageStyles.page}>
      <div className={pageStyles.layout}>
        <CompanySidebar isOpen={mobileNavOpen} onClose={() => setMobileNavOpen(false)} />
