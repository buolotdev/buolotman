            ...
            <div className={styles.conversationList}>
              {loading ? (
                ...
                <div style={{ textAlign: "center", padding: "48px 24px", color: "#64748b" }}>
                  <iconify-icon icon="lucide:message-square" style={{ fontSize: "48px", display: "block", marginBottom: "16px" }}></iconify-icon>
                  <h3 style={{ margin: "0 0 8px", color: "#0f172a" }}>No conversations</h3>
                  <p style={{ margin: 0 }}>Start a conversation to see it here.</p>
                </div>
              ) : (
