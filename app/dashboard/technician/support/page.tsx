...
import pageStyles from "@/app/dashboard/technician/page.module.css";
...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    subject: "Subject",
    subjectPlaceholder: "E.g. Issue with payout or task verification",
    describeIssue: "Describe your issue",
    issuePlaceholder: "Please provide details so we can assist you...",
    cancel: "Cancel",
  ...
  fr: {
    ...
    subject: "Objet",
    subjectPlaceholder: "Ex. Problème avec un paiement ou une vérification",
